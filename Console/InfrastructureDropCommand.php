 ...
 */
class InfrastructureDropCommand extends EventBusCommand
{
    /**
     * @var AsyncAdapter
     */
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        (new EventBusHeaderMessage('', 'Started dropping infrastructure...'))->print($outputPrinter);
        ...
        try {
            $promise = $this
                ...
                ->then(function () use ($outputPrinter) {
                    (new EventBusHeaderMessage('', 'Infrastructure dropped'))->print($outputPrinter);
                });
